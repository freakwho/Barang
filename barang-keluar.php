...
if (isset($_POST['filter'])) {
    ...
    $data_barang = select("SELECT * FROM barangkeluar WHERE tanggal BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id_keluar DESC");
} else {
    // Ambil semua Data Barang berdasarkan urutan id_barang 
    $data_barang = select("SELECT * FROM barangkeluar ORDER BY id_keluar DESC");
                                            ...
                                            <?php foreach ($data_barang as $barang) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="cancel-barang-keluar.php?id_keluar=<?= $barang['id_keluar']; ?>" class="btn btn-danger mb-1" onclick="return confirm('Apakah Anda yakin ingin mengCancel barang ini ?');"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Cancel Action</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
